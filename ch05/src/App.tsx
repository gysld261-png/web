...
import love from './assets/images/1.jpg'
function App() {
  const styles = {
  ...
  return (
    <>
     ...
     <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatum cupiditate fugiat cumque reprehenderit, laboriosam reiciendis, laborum a exercitationem quo porro soluta eaque repellendus corrupti quaerat ducimus, totam minus autem facilis?</p>
    </>
  )
}
